...
export const LUGO_LANDMARKS = [
  ...
  { name: 'Estación de Autobuses de Lugo (Praza da Constitución)', lat: 43.0101, lng: -7.5518, zone: 'Centro' },
  { name: 'Estación de Ferrocarril Adif (Praza Conde Fontao)', lat: 43.0185, lng: -7.5512, zone: 'Estación Tren' },
  { name: 'Centro Comercial As Termas', lat: 43.0315, lng: -7.5612, zone: 'O Ceao' },
  { name: 'Parque Rosalía de Castro', lat: 43.0051, lng: -7.5575, zone: 'Sur' },
  { name: 'Parque da Milagrosa', lat: 43.0205, lng: -7.5606, zone: 'A Milagrosa' },
  { name: 'Pazo de Feiras e Congresos de Lugo', lat: 42.9989, lng: -7.5678, zone: 'Ribeira Miño' },
  { name: 'Complexo Deportivo Palomar / Ancar', lat: 43.0195, lng: -7.5695, zone: 'Oeste' },
  { name: 'Piscina Municipal As Pedreiras', lat: 43.0018, lng: -7.5512, zone: 'Sur' },
  { name: 'Pazo Provincial dos Deportes (CB Breogán)', lat: 42.9885, lng: -7.5495, zone: 'Acea de Olga' },
  { name: 'Centro Comercial Abella (Antigo)', lat: 43.0218, lng: -7.5684, zone: 'Casás' },
